...
export default function AboutEN() {
  return (
    <main className="bg-white">
      {/* Hero Section */}
      <section className="relative bg-gradient-to-br from-[#1c7a9e] via-[#2596be] to-[#3db3d9] text-white pt-24 pb-16 md:pt-28 md:pb-20">
        ...
        <div className="relative container-main max-w-7xl">
            ...
            {[
              {
                letter: "A",
                word: "ABILITY",
                desc1: "Talented and skilled",
                desc2: "production team",
              },
              {
                letter: "B",
                word: "BRILLIANT",
                desc1: "Outstanding and successful",
                desc2: "achievements and track record",
              },
              {
                letter: "O",
                word: "ORIGINALITY",
                desc1: "Creative ideas and",
                desc2: "innovative direction",
              },
            ].map((item) => (
          ...
          <div className="mt-12 md:mt-24 text-left md:text-center max-w-3xl mx-auto">
            <p className="text-base md:text-2xl text-white/80 leading-relaxed">
              ABO Media creates content that brings{" "}
              <span className="text-[#3db3d9] font-bold">emotion</span> and{" "}
              <span className="text-[#3db3d9] font-bold">joy</span> to viewers
              based on{" "}
              <span className="text-[#3db3d9] font-bold">talent</span>,{" "}
              <span className="text-[#3db3d9] font-bold">achievement</span>, and{" "}
              <span className="text-[#3db3d9] font-bold">originality</span>.
            </p>
          </div>
        </div>
      </section>
